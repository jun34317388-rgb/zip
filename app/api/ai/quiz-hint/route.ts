...
원문 강의 내용만을 기반으로, 학습자가 왜 헷갈렸는지 짚어주고 올바른 개념을 상기할 수 있도록 맞춤 복습 힌트를 2~3문장으로 간결하게 작성하세요.
...
{
  "whyWrong": "학습자가 선택한 보기의 오류 이유 (1문장)",
  "reviewGuide": "원문에서 다시 주목해야 할 핵심 문장이나 정의 (1문장)",
  "keyPoint": "핵심 키포인트 요약 (1문장)"
}`;
